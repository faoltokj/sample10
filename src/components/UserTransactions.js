...
import { Box, Typography, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Alert, CircularProgress } from '@mui/material';
...
const UserTransactions = () => {
  ...
  useEffect(() => {
    const fetchTransactions = async () => {
      ...
      try {
        ...
        // Filter transactions from the last 2 months
  ...
  return (
    <Box sx={{ p: 4, maxWidth: 900, margin: 'auto' }}>
      <Typography variant="h4" mb={3} align="center" sx={{ fontWeight: 'bold', color: 'primary.main' }}>
        Transaction History
      </Typography>
